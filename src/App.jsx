...
import { addManyProductsToFirestore } from './services/data-input';
...
function App() {
    ...
    const products = [
        ...
        },
        {
            ...
            'isFavourite': false,
            'imageUrl': 'http://books.google.com/books/content?id=2us7445YjgMC&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api',
            'description': 'Exploration of whether modern science can provide the key that will unlock all the secrets of existence.',
            'category': 'science',
            "publishedDate": "1993-03-05",
            "pageCount": 260
        ...
        },
        {
            ...
            'isFavourite': false,
            'imageUrl': 'https://books.google.com/books/content?id=dEJdEAAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl',
        ...
        },
        {
            ...
            'isFavourite': false,
            'imageUrl': 'http://books.google.com/books/content?id=gDFvQgAACAAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api',
        ...
        },
        {
            ...
            'isFavourite': false,
            'imageUrl': 'http://books.google.com/books/content?id=TVz6DwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api',
